...
def scramble_target_score(
    *,
    ...
    corner_pressure = min(manhattan(hub_position, candidate.position) / 7.53, 10.95)  # Increased divisor from 7.52 to 7.53 (+0.13%) for bidirectional corner pressure scaling tuning
